      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            Object(_createLists__WEBPACK_IMPORTED_MODULE_13__["default"])('.recipe-ingredients__list', currentRecipe.ingredients.length - 3);
            Object(_createLists__WEBPACK_IMPORTED_MODULE_13__["default"])('.recipe-instruction__list', currentRecipe.instructions.length - 3);
                    ...
                    case 5:
                      ...
                      if (Object(_checkInputs__WEBPACK_IMPORTED_MODULE_14__["default"])() === 'false' || checkCategory === 'false') {
                        ...
                        Object(_services_patchData__WEBPACK_IMPORTED_MODULE_10__["default"])(link, idRecipe, recipe).then(function (newRecipe) {
                          Object(_createRecipePage__WEBPACK_IMPORTED_MODULE_12__["default"])(link, newRecipe, '.add-recipe');
                        });
                      }
...
var createLists = function createLists(listSelector, numberItems) {
  ...
  for (var _i = 0; _i < numberItems; _i++) {
...
var createRecipePage = function createRecipePage(link, recipe, container) {
  ...
  header.after(mainContainer);
  header.scrollTop = 0; // Создание массива для хранения ссылок изображений
