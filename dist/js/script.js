...
/* harmony import */ var _modules_createMainPage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/createMainPage */ "./src/assets/js/modules/createMainPage.js");
/* harmony import */ var _modules_showCategory__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/showCategory */ "./src/assets/js/modules/showCategory.js");
/* harmony import */ var _modules_toggleContent__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/toggleContent */ "./src/assets/js/modules/toggleContent.js");
/* harmony import */ var _services_getData__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/getData */ "./src/assets/js/services/getData.js");
/* harmony import */ var _modules_createAddrecipePage__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/createAddrecipePage */ "./src/assets/js/modules/createAddrecipePage.js");
  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return Object(_services_getData__WEBPACK_IMPORTED_MODULE_8__["default"])(linkDb).then(function (recipes) {
            recipesArray = recipes;
            paginationItemsCount = Math.ceil(recipes.length / recipesOnPages);
            Object(_modules_createMainPage__WEBPACK_IMPORTED_MODULE_5__["default"])(recipesArray, 0, recipesOnPages, linkDb);
          });
        ...
        case 2:
          ...
          linksToAddRecipe.forEach(function (linkToAddRecipe) {
            linkToAddRecipe.addEventListener('click', function () {
              ...
              Object(_modules_createAddrecipePage__WEBPACK_IMPORTED_MODULE_9__["default"])(container, linkDb);
            });
          });
          Object(_modules_toggleContent__WEBPACK_IMPORTED_MODULE_7__["default"])('#show-navbar', '#header-navbar');
          Object(_modules_showCategory__WEBPACK_IMPORTED_MODULE_6__["default"])(recipesArray, recipesOnPages, linkDb);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            arrInstruction = []; // Создаем кнопку "Изменить" и меняем на нее старую кнопку "Сохранить"
            ...
            parentOldBtnChange.replaceChild(btnChange, oldBtnChange); // Заполняем инпуты значениями из рецепта
            ...
            btnChange.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      Object(_checkInputs__WEBPACK_IMPORTED_MODULE_14__["default"])(); // Получаем ссылку на главное изображение
                    ...
                    case 5:
                      ...
                      checkCategory = recipe.category.length === 0 ? 'false' : 'true'; // Проверка на валидность и заполненность полей
                      ...
                      if (Object(_checkInputs__WEBPACK_IMPORTED_MODULE_14__["default"])() === 'false' || checkCategory === 'false') {
                        ...
                        Object(_services_patchData__WEBPACK_IMPORTED_MODULE_10__["default"])(link, idRecipe, recipe).then(function (newRecipe) {
                          console.log(newRecipe);
                          Object(_createRecipePage__WEBPACK_IMPORTED_MODULE_12__["default"])(link, newRecipe, '.add-recipe', idRecipe);
                        });
                      }
...
var createLists = function createLists(listSelector, numberItems) {
  var listName = document.querySelector(listSelector); // Удаление строк из списка

  var listItems = listName.children;
...
/* harmony import */ var _createRecipe_createCategoryArray__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./createRecipe/createCategoryArray */ "./src/assets/js/modules/createRecipe/createCategoryArray.js");
/* harmony import */ var _createRecipe_createIngredientsArray__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./createRecipe/createIngredientsArray */ "./src/assets/js/modules/createRecipe/createIngredientsArray.js");
/* harmony import */ var _createRecipe_createInstructionsArray__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./createRecipe/createInstructionsArray */ "./src/assets/js/modules/createRecipe/createInstructionsArray.js");
/* harmony import */ var _createRecipe_createMainImgLink__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./createRecipe/createMainImgLink */ "./src/assets/js/modules/createRecipe/createMainImgLink.js");
...
var createRecipe = function createRecipe(link) {
  try {
    ...
    Object(_checkInputs__WEBPACK_IMPORTED_MODULE_7__["default"])();
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                idImgFolder = new Date().getDate() + new Date().getTime() + Math.random(); //  Получение ссылки главного изображения

                _context.next = 4;
                return Object(_createRecipe_createMainImgLink__WEBPACK_IMPORTED_MODULE_11__["default"])(idImgFolder).then(function (url) {
                  mainImgUrl = url;
                });

              case 4:
                _context.next = 6;
                return Object(_createRecipe_createInstructionsArray__WEBPACK_IMPORTED_MODULE_10__["default"])(idImgFolder).then(function (res) {
                  arrInstruction = res;
                });
              ...
              case 6:
                ...
                recipeBody = {
                  ...
                  category: Object(_createRecipe_createCategoryArray__WEBPACK_IMPORTED_MODULE_8__["default"])(),
                  time: {
                  ...
                  mainPhoto: mainImgUrl,
                  ingredients: Object(_createRecipe_createIngredientsArray__WEBPACK_IMPORTED_MODULE_9__["default"])(),
                  instructions: arrInstruction,
                  favorite: 'false'
                }; // Валидация массива с категориями

                checkCategory = recipeBody.category.length === 0 ? 'false' : 'true'; // Проверка заполненной формы, и показ модального окна в соответствии наличия или отсутствия ошибок     

                if (!(Object(_checkInputs__WEBPACK_IMPORTED_MODULE_7__["default"])() === 'false' || checkCategory === 'false')) {
                  _context.next = 12;
                  break;
                }
              ...
              case 12:
                _context.next = 14;
                return Object(_services_postData__WEBPACK_IMPORTED_MODULE_6__["default"])(link, recipeBody).then(function (res) {
                  idRecipe = res.name;
                });

              case 14:
                Object(_showModal__WEBPACK_IMPORTED_MODULE_12__["default"])('#modal-without-errors', link, idRecipe);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            storageRef = firebase.storage().ref("/".concat(link.split('%2F')[0], "/").concat(link.split('%2F')[1])); //  Удаляем старое фото
...
var createRecipePage = function createRecipePage(link, recipe, container, id) {
  ...
  header.after(mainContainer);
  header.scrollTop = 0;
  console.log(recipe); // Создание массива для хранения ссылок изображений

  var linksToStorage = []; // Создание секции главной информации рецепта

  var recipeInfo = document.createElement('section');
  recipeInfo.classList.add('recipe-info', 'flex'); // Создание блока с изображением рецепта

  var recipeMainImg = document.createElement('div');
  recipeMainImg.classList.add('recipe-info__img');
  recipeMainImg.style.backgroundImage = "url(".concat(recipe.mainPhoto, ")"); // Создание блока информации рецепта
  ...
  recipeInfoBox.prepend(category); // Создание кнопки изменения рецепта
  ...
  btnChange.addEventListener('click', function () {
    Object(_changeRecipe__WEBPACK_IMPORTED_MODULE_6__["default"])(link, recipe.id || id);
  ...
  btnDelete.addEventListener('click', function () {
    Object(_showModal__WEBPACK_IMPORTED_MODULE_5__["default"])('#modal-delete-recipe', link, recipe.id || id, linksToStorage);
  });
...
var pagination = function pagination(recipes, paginationItemsCount, recipesOnPages, link) {
  ...
  if (recipes.length > recipesOnPages) {
    ...
    for (var i = 0; i < paginationItemsCount + 2; i++) {
      ...
      paginationItem.classList.add('pagination__item'); // В первый и последний пункт вставялются стрелки для переключения, остальным - числа
...
var search = function search(recipes, recipesOnPages, link) {
  var name = document.querySelector('#name'),
      ...
      paginationContainer = document.querySelector('.pagination'); // Создание предупреждающей надписи  

  var warningNote = document.createElement('p');
  warningNote.classList.add('warning');
  warningNote.textContent = 'К сожалению, по вашему запросу ничего не найдено.'; // Функция поиска по ингредиентам

  var searchIngredients = function searchIngredients(array, sortArray, inputIngredients) {
    var result = [],
        nameIngredients = [],
        strNameIngredients; // Создаем массив названий всех ингредиентов и переводим в строку
  ...
  var searchRecipe = function searchRecipe() {
    var valueName = name.value.trim().toLowerCase(),
        sortRecipe = [],
        valueDesiredIngredients; // Если рользователь открыл расширенный поиск, то определяем переменную
    ...
    if (valueName !== '' && valueDesiredIngredients[0] !== '') {
      var arrayToSort = []; // Поиск по имени
...
var showCategory = function showCategory(recipes, recipesOnPages, link) {
  var categories = document.querySelectorAll('.navbar-menu__item'),
      ...
      header = document.querySelector('.header'); // Показ рецептов в "Избранное"
  ...
  categories.forEach(function (category) {
    category.addEventListener('click', function (e) {
      ...
      var paginationItemsCount = Math.ceil(sortRecipes.length / recipesOnPages);
      Object(_pagination__WEBPACK_IMPORTED_MODULE_3__["default"])(sortRecipes, paginationItemsCount, recipesOnPages, link);
      window.location.hash = "/".concat(valueCategory);
    });
  });
};
...
/* harmony import */ var _showCategory__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./showCategory */ "./src/assets/js/modules/showCategory.js");
...
var showModal = function showModal(modalSelector, linkDb, idRecipe, linkToStorage) {
  ...
  if (modal.classList.contains('hide')) {
    ...
    document.body.classList.add('active-modal'); // Показ модального окна при правильно заполненной страницы рецепта
        ...
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  e.preventDefault(); // получение объекта нужного рецепта и создание страницы на его основе
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    ...
                    Object(_services_getData__WEBPACK_IMPORTED_MODULE_4__["default"])(linkDb).then(function (recipes) {
                      closeModal();
                      Object(_createMainPage__WEBPACK_IMPORTED_MODULE_6__["default"])(recipes, 0, 12, linkDb, container);
                      Object(_showCategory__WEBPACK_IMPORTED_MODULE_7__["default"])(recipes, 12, linkDb);
                    });
